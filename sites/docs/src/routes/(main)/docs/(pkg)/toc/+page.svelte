<script lang="ts">
  ...
  const SECTION_IDS = {
    toclink: 'complementary-toclink-action',
  };
</script>
...
<section>
  ...
  <p class="c-callout-info">
    ...
    out the
    <ResourceLink
      href="https://github.com/vnphanquang/svelte-put/blob/main/sites/docs/src/routes/(main)/+layout.svelte"
    >
      source code here
...
<section>
  ...
  <p>
    ...
    <code>toc</code>
    action. See <ResourceLink id={SECTION_IDS.toclink}
...
<section>
  ...
  <section>
    ...
    <p>
      ...
      is explained and an idiomatic solution is provided in <ResourceLink id={SECTION_IDS.toclink}
...
<section>
  <h2 id={SECTION_IDS.toclink}>Complementary <code>toclink</code> Action</h2>
  <p>
...
<section>
  ...
  <section>
    <h3>On Toc Elements</h3>
    <p>
      Attributes listed below can be used to override behavior of <code>toc</code> per matching
      element. All of them are <code>undefined</code> by default.
    </p>
    <div class="not-prose c-gtable-2 max-w-full direct-children:p-4">
      <p>Name</p>
      <p>Description</p>

      <p><code>{ATTRIBUTES.id}</code></p>
      <p>
        The <code>id</code> to use for this element in <code>toc</code> context. If not provided,
        this will be the element <code>id</code>, or generated by <code>toc</code> if element does
        not have an <code>id</code> either<br />
        <span class="inline-block pt-2 text-sm">
          <strong>type</strong>: <code>string</code><br />
          <strong>mutability</strong>: customizable
        </span>
      </p>

      <p><code>{ATTRIBUTES.ignore}</code></p>
      <p>
        Whether to ignore this element when searching for matching elements<br />
        <span class="inline-block pt-2 text-sm">
      ...
      <p><code>{ATTRIBUTES.strategy}</code></p>
      <p>
        Override the <code>strategy</code> for this element to use in creating
        <code>IntersectionObserver</code>. This only has effect if the <code>observe</code> option
        is enabled in <code>toc</code> parameters<br />
        <span class="inline-block pt-2 text-sm">
          <strong>type</strong>: <code>'parent' | 'self' | 'auto'</code><br />
          <strong>mutability</strong>: customizable
        </span>
      </p>

      <p><code>{ATTRIBUTES.threshold}</code></p>
      <p>
  ...
  <section>
    <h3>By Observe Operation</h3>
    <p>The following attributes are utilized by the <code>observe</code> operation when enabled.</p>
    <div class="not-prose c-gtable-2 max-w-full direct-children:p-4">
      <p>Name</p>
      <p>Description</p>

      <p><code>{ATTRIBUTES.observeFor}</code></p>
      <p>
        Added to the element where <code>IntersectionObserver</code> is used when
        <code>observe</code> is turned on and references the associated toc element<br />
        <span class="inline-block pt-2 text-sm">
          <strong>type</strong>: <code>string</code><br />
          <strong>mutability</strong>: readonly
        </span>
      </p>

      <p><code>{ATTRIBUTES.observeActiveId}</code></p>
      <p>
        Added to <code>toc</code> root (the element where <code>toc</code> action is placed on) and
        references the <code>id</code> of the active matching element<br />
        <span class="inline-block pt-2 text-sm">
          <strong>type</strong>: <code>string</code><br />
          <strong>mutability</strong>: customizable
        </span><br />
        <span class="c-callout-info my-2 inline-block"
          >This attribute is reactive. When changed (either by <code>toc</code> or manually), it will
          trigger events and store updates accordingly</span
        >
      </p>

      <p><code>{ATTRIBUTES.observeThrottled}</code></p>
      <p>
        Added to <code>toc</code> root (the element where <code>toc</code> action is placed on) and
        indicate whether <code>observe</code> is being throttled, typically seen in conjunction with
        usage of the complementary <ResourceLink id={SECTION_IDS.toclink}>toclink</ResourceLink> action<br
        />
        <span class="inline-block pt-2 text-sm">
          <strong>type</strong>: <code>boolean</code><br />
          <strong>mutability</strong>: readonly
      ...
      <p><code>{ATTRIBUTES.linkActive}</code></p>
      <p>
        Added to the element where <ResourceLink id={SECTION_IDS.toclink}>toclink</ResourceLink> is used
        and set to <code>true</code> when the linked toc element is active<br />
        <span class="inline-block pt-2 text-sm">
          <strong>type</strong>: <code>boolean</code><br />
          <strong>mutability</strong>: readonly
        </span>
  ...
  <section>
    ...
    <div class="not-prose c-gtable-2 max-w-full direct-children:p-4">
      ...
      <p><code>{ATTRIBUTES.toc}</code></p>
      <p>
        Marking this element that it's been processed by <code>toc</code>
        <br />
        <span class="c-callout-info inline-block">
          If this is already preprocessed by <ResourceLink
            key="@svelte-put/preprocess-auto-slug"
          />, there will also be a <code>{ATTRIBUTES.autoslug}</code> attribute.
        </span>
      </p>

      <p><code>{ATTRIBUTES.anchor}</code></p>
      <p>
        If the <code>anchor</code> option is enabled in <code>toc</code> parameters, this attribute
      ...
      <p><code>{ATTRIBUTES.root}</code></p>
      <p>Added to the element where <code>toc</code> action is used for internal reference</p>

      <p><code>{ATTRIBUTES.linkFor}</code></p>
      <p>
        Added to the element where <ResourceLink id={SECTION_IDS.toclink}>toclink</ResourceLink> action
        is used and references the linked toc element
      </p>
    </div>
  </section>
</section>
